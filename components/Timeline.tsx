  ...
  const timelineData: TimelineItem[] = [
    {
      ...
      technologies: ["Full Stack", "Expert", "Technologies modernes"],
      gradientFrom: "#8A2BE2",
      gradientTo: "#6B46C1",
      pointColor: "#8A2BE2",
      icon: (
    ...
    },
    {
      ...
      description: "Stage de fin d&apos;études au laboratoire de recherche Icube pour développer des solutions innovantes et approfondir mes compétences techniques.",
      technologies: ["Recherche", "Innovation", "Développement"],
      gradientFrom: "#69B7EE",
      gradientTo: "#5A9BD4",
      pointColor: "#69B7EE",
      icon: (
    ...
    },
    {
      ...
      period: "2022 - 2025",
              description: "Formation complète en développement web, design graphique, audiovisuel et communication numérique à l&apos;IUT de Haguenau.",
      technologies: ["Développement Web", "Design", "Audiovisuel"],
      gradientFrom: "#E5A4E1",
      gradientTo: "#D691DD",
      pointColor: "#E5A4E1",
      icon: (
    ...
    },
    {
      ...
      technologies: ["Agence", "Communication", "Web"],
      gradientFrom: "#5A1441",
      gradientTo: "#7A1D5A",
      pointColor: "#5A1441",
      icon: (
    ...
    },
    {
      ...
      period: "2021 - 2022",
      description: "Première année en informatique qui m&apos;a permis de découvrir la programmation avant de me réorienter vers le multimédia.",
      technologies: ["Informatique", "Programmation", "Bases"],
      gradientFrom: "#FF9776",
      gradientTo: "#E8845C",
      pointColor: "#FF9776",
      icon: (
